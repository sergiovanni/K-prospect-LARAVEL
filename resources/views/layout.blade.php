    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="#">
                ...
                <span class="ms-2 font-weight-bold">K-PROSPECT</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @if (auth()->user()->hasRole('commercial'))
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home_com') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                            </div>
                ...
                @if (auth()->user()->hasRole('admin'))
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('commercials.index') }}">
                            ...
                            <span class="nav-link-text ms-1">Commerciaux</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('prospects.index') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">Prospects</span>
                        </a>
                    </li>
                @endif
                ...
                @if (auth()->user()->hasRole('commercial'))
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('prospections.index') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="fas fa-address-book text-info text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">Prospections</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                made with <i class="fa fa-heart"></i> by dev
                                <a href="https://www.creative-tim.com" class="font-weight-bold"
                                    target="_blank">K-PROSPECT</a>
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0 overflow-auto">
                ...
                <div class="d-flex">
                    ...
                    <button class="btn bg-gradient-primary w-100 px-3 mb-2 active " data-class="bg-default"
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          navLinks.forEach(link => {
              link.addEventListener('click', function() {
                  navLinks.forEach(nav => nav.classList.remove('active')); // Retire la classe active de tous les liens
